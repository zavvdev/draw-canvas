...
module.exports = {
  forbidden: [
...

    {
      ...
      from: { path: "^src/utilities" },
      to: {
        path: "^src/(components|App.jsx|main.jsx)",
      },
    },
    {
      severity: "error",
...
// generated: dependency-cruiser@17.3.8 on 2026-02-28T10:01:27.593Z
